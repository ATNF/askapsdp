...
aprun \${ASKAP_ROOT}/Code/Components/Synthesis/synthesis/current/apps/mssplit.sh -c ${CONFIGDIR}/mssplit_coarse_\${PBS_ARRAY_INDEX}.in > ${LOGDIR}/mssplit_coarse_\${PBS_ARRAY_INDEX}.log
EOF
