...
$ASKAP_ROOT/Code/Components/CP/correlatorsim/current/apps/vsnoop -v -p 3000 > vsnoop.log 2>&1 &
VISPID=$!

# Run the test
mpirun -np 2 $ASKAP_ROOT/Code/Components/CP/correlatorsim/current/apps/playback.sh -inputs playback.in
STATUS=$?
