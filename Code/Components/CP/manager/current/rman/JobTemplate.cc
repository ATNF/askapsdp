...
std::string JobTemplate::getName(void)
{
    return itsName;
}
...
std::string JobTemplate::getScriptLocation(void)
{
    return itsPathToScript;
}

void JobTemplate::addDependency(JobId dependency, DependType type)
{
    itsDependencies[dependency] = type;
}

void JobTemplate::removeDependency(JobId dependency)
{
    itsDependencies.erase(dependency);
}
