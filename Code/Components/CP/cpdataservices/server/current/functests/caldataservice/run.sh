...
nohup java -Xmx1024m askap/cp/caldatasvc/Server --Ice.Config=config.caldatasvc > ${APP_LOG} &
PID=$!
waitIceAdapter config.icegridadmin CalibrationDataServiceAdminAdapter
