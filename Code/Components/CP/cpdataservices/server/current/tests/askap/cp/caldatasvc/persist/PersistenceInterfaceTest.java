...
public class PersistenceInterfaceTest {
	 ...
	 * Class under test.
	 */
	askap.cp.caldatasvc.persist.PersistenceInterface itsInstance;
	...
	public void setUp() throws Exception {
		...
		config.addClass(askap.cp.caldatasvc.persist.GainSolutionBean.class);
		config.addClass(askap.cp.caldatasvc.persist.GainSolutionElementBean.class);
		config.addClass(askap.cp.caldatasvc.persist.LeakageSolutionBean.class);
		config.addClass(askap.cp.caldatasvc.persist.LeakageSolutionElementBean.class);
		config.addClass(askap.cp.caldatasvc.persist.BandpassSolutionBean.class);
		config.addClass(askap.cp.caldatasvc.persist.BandpassSolutionElementBean.class);
	...
	/**
	 * Test method for {@link askap.cp.caldatasvc.persist.PersistenceInterface#addGainSolution(askap.cp.caldatasvc.persist.TimeTaggedGainSolutionBean)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link askap.cp.caldatasvc.persist.PersistenceInterface#addLeakageSolution(askap.cp.caldatasvc.persist.TimeTaggedLeakageSolutionBean)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link askap.cp.caldatasvc.persist.PersistenceInterface#addBandpassSolution(askap.cp.caldatasvc.persist.TimeTaggedBandpassSolutionBean)}.
	 */
	@Test
