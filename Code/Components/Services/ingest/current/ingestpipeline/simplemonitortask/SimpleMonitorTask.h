...
class SimpleMonitorTask : public askap::cp::ingest::ITask {
    ...
    private:
        ...
        /// the current form of monitoring is not very suitable for cross-pols.
        /// The mapping is setup the same way as for the main baseline map, but
        /// parset prefixes are different, for example:
        ///
