...
/// Due to imperfections of the correlator/early system there are many spikes in
/// the data which complicate initial setup and analysis. Although we can take
/// care of them off-line using cflag, it is handy to be able to see clear data
/// in the on-the-fly monitoring and average in frequency on-the-fly.
...
class FileFlagTask : public askap::cp::ingest::ITask {
    public:
        ...
        /// CFB DC offset. Note, the intention is to run this task early in the
        /// chain to work on full resolution. There is no check of any kind that
        /// the supplied channel numbers are valid.
        ///
