...
public class MonitoringSingleton {
     ...
     * @param serviceName   the name that will be registered in the Ice registry
     *                      for this monitoring provider object
     * @param adapterName   the name of the Ice object adapter that will be
     *                      used to host the monitoring provider singleton
     *                      object
     */
