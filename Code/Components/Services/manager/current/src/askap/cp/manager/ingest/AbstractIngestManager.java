...
public abstract class AbstractIngestManager {
    ...
    private static final Logger logger = Logger.getLogger(
            AbstractIngestManager.class.getName());

    /**
     * Parameter set (i.e. configuration from file)
     */
    private final ParameterSet itsParset;
     ...
     *
     * @param facilityConfig the facility configuration to be used to configure
     *                       the ingest pipeline
     * @param sbid           scheduling block id for the currently running scheduling block
     ...
     *
     * @param timeout the maximum time to wait in milliseconds. Once the timeout
