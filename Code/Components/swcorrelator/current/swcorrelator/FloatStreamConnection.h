...
#ifndef ASKAP_SWCORRELATOR_FLOAT_STREAM_CONNECTION
#define ASKAP_SWCORRELATOR_FLOAT_STREAM_CONNECTION
...
#endif // #ifndef ASKAP_SWCORRELATOR_FLOAT_STREAM_CONNECTION
