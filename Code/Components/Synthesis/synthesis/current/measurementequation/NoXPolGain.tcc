...
#ifndef NO_X_POL_GAIN_TCC
#define NO_X_POL_GAIN_TCC
...
/// this effect
inline scimath::ComplexDiffMatrix NoXPolGain::get(const accessors::IConstDataAccessor &chunk, 
                                      casa::uInt row) const
{
...
#endif // #ifndef NO_X_POL_GAIN_TCC
