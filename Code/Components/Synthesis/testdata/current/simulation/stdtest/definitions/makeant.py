...
config["ADE6_ALT1_PROPOSED"]     = AntennaConfig("ADE6_ALT1_PROPOSED",     ( 2, 4, 5,19,10,12))
config["ADE6_ALT2_PROPOSED"]     = AntennaConfig("ADE6_ALT2_PROPOSED",     ( 2, 4, 5,11,10,12))
config["ADE6_ALT_TT_PROPOSED"]   = AntennaConfig("ADE6_ALT_TT_PROPOSED",   ( 2, 4, 5,14,10,12))
config["ADE6_ALT5_PROPOSED"]     = AntennaConfig("ADE6_ALT5_PROPOSED",     ( 2, 4, 5,17,10,12))
config["ADE12_PROPOSED"]         = AntennaConfig("ADE12_PROPOSED",         ( 2, 4, 5, 7,10,12,24,27,30,13,16,28))
config["ADE12_ALT1_PROPOSED"]    = AntennaConfig("ADE12_ALT1_PROPOSED",    ( 2, 4, 5,19,10,12,24,27,30,13,16,28))
config["ADE12_ALT2_PROPOSED"]    = AntennaConfig("ADE12_ALT2_PROPOSED",    ( 2, 4, 5,11,10,12,24,27,30,13,16,28))
config["ADE12_ALT_TT_PROPOSED"]  = AntennaConfig("ADE12_ALT_TT_PROPOSED",  ( 2, 4, 5,14,10,12,24,27,30,13,16,28))
config["ADE12_ALT5_PROPOSED"]    = AntennaConfig("ADE12_ALT5_PROPOSED",    ( 2, 4, 5,17,10,12,24,27,30,13,16,28))
config["ADE18_PROPOSED"]         = AntennaConfig("ADE18_PROPOSED",         ( 2, 4, 5, 7,10,12,24,27,30,13,16,28,31,33,35,14,19,26))
config["ADE18_ALT2_PROPOSED"]    = AntennaConfig("ADE18_ALT2_PROPOSED",    ( 2, 4, 5,11,10,12,24,27,30,13,16,28,31,33,35,14,19,26))
config["ADE18_ALT3_PROPOSED"]    = AntennaConfig("ADE18_ALT3_PROPOSED",    ( 2, 4, 5,21,10,12,24,27,30,13,16,28,31,33,35,14,19,26))
config["ADE18_ALT_TT_PROPOSED"]  = AntennaConfig("ADE18_ALT_TT_PROPOSED",  ( 2, 4, 5,23,10,12,24,27,30,13,16,28,31,33,35,14,19,26))
config["ADE18_ALT5_PROPOSED"]    = AntennaConfig("ADE18_ALT5_PROPOSED",    ( 2, 4, 5,17,10,12,24,27,30,13,16,28,31,33,35,14,19,26))
