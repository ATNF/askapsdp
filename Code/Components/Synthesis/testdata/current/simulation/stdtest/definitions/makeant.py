...
config["ADE6_PROPOSED"]          = AntennaConfig("ADE6_PROPOSED",          ( 2, 4, 5, 7,10,12))
...
config["ADE12_PROPOSED"]         = AntennaConfig("ADE12_PROPOSED",         ( 2, 4, 5, 7,10,12,24,27,30,13,16,28))
...
config["ADE18_PROPOSED"]         = AntennaConfig("ADE18_PROPOSED",         ( 2, 4, 5, 7,10,12,24,27,30,13,16,28,31,33,35,14,19,26))
