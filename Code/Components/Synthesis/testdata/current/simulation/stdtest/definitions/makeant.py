...
config["ADE6_POSS_SJ1"]          = AntennaConfig("ADE6_POSS_SJ1",          ( 4, 5,11,17,25,26))
config["ADE6_POSS_SJ2"]          = AntennaConfig("ADE6_POSS_SJ2",          ( 4, 5,11,12,19,20))
config["ADE6_POSS_MJK"]          = AntennaConfig("ADE6_POSS_MJK",          ( 4, 5,10,11,18,19))
config["ADE6_POSS_JB"]           = AntennaConfig("ADE6_POSS_JB",           (10,11,18,21,22,29))
config["ADE6_POSS_JB2"]          = AntennaConfig("ADE6_POSS_JB",           (10,11,18,21,22, 7))
config["ADE6_POSS_JB3"]          = AntennaConfig("ADE6_POSS_JB",           (10,11,18,21,22,19))
config["ADE12_POSS_EMU1.5"]      = AntennaConfig("ADE12_POSS_EMU1.5",      ( 4, 5, 7,10,11,12,14,16,18,21,23,26))
config["ADE12_POSS_EMU3"]        = AntennaConfig("ADE12_POSS_EMU3",        ( 4, 5,10,18,19,20,25,27,28,29,35,36))
config["ADE12_POSS_EMU6"]        = AntennaConfig("ADE12_POSS_EMU6",        ( 4, 5,10,17,19,20,27,29,32,33,35,36))
config["ADE12_POSS_WALLABY"]     = AntennaConfig("ADE12_POSS_WALLABY",     ( 2, 4, 5, 7,10,11,12,14,16,17,18,19))
config["ADE6_AK07_PROPOSED"]     = AntennaConfig("ADE6_AK07_PROPOSED",     ( 2, 4, 5, 7,10,12))
config["ADE6_AK19_PROPOSED"]     = AntennaConfig("ADE6_AK19_PROPOSED",     ( 2, 4, 5,19,10,12))
config["ADE6_AK11_PROPOSED"]     = AntennaConfig("ADE6_AK11_PROPOSED",     ( 2, 4, 5,11,10,12))
config["ADE6_AK14_PROPOSED"]     = AntennaConfig("ADE6_AK14_PROPOSED",     ( 2, 4, 5,14,10,12))
config["ADE6_AK17_PROPOSED"]     = AntennaConfig("ADE6_AK17_PROPOSED",     ( 2, 4, 5,17,10,12))
config["ADE12_AK07_PROPOSED"]    = AntennaConfig("ADE12_AK07_PROPOSED",    ( 2, 4, 5, 7,10,12,24,27,30,13,16,28))
config["ADE12_AK19_PROPOSED"]    = AntennaConfig("ADE12_AK19_PROPOSED",    ( 2, 4, 5,19,10,12,24,27,30,13,16,28))
config["ADE12_AK11_PROPOSED"]    = AntennaConfig("ADE12_AK11_PROPOSED",    ( 2, 4, 5,11,10,12,24,27,30,13,16,28))
config["ADE12_AK14_PROPOSED"]    = AntennaConfig("ADE12_AK14_PROPOSED",    ( 2, 4, 5,14,10,12,24,27,30,13,16,28))
config["ADE12_AK17_PROPOSED"]    = AntennaConfig("ADE12_AK17_PROPOSED",    ( 2, 4, 5,17,10,12,24,27,30,13,16,28))
config["ADE18_AK07_PROPOSED"]    = AntennaConfig("ADE18_AK07_PROPOSED",    ( 2, 4, 5, 7,10,12,24,27,30,13,16,28,31,33,35,14,19,26))
config["ADE18_AK11_PROPOSED"]    = AntennaConfig("ADE18_AK11_PROPOSED",    ( 2, 4, 5,11,10,12,24,27,30,13,16,28,31,33,35,14,19,26))
config["ADE18_AK21_PROPOSED"]    = AntennaConfig("ADE18_AK21_PROPOSED",    ( 2, 4, 5,21,10,12,24,27,30,13,16,28,31,33,35,14,19,26))
config["ADE18_AK23_PROPOSED"]    = AntennaConfig("ADE18_AK23_PROPOSED",    ( 2, 4, 5,23,10,12,24,27,30,13,16,28,31,33,35,14,19,26))
config["ADE18_AK17_PROPOSED"]    = AntennaConfig("ADE18_AK17_PROPOSED",    ( 2, 4, 5,17,10,12,24,27,30,13,16,28,31,33,35,14,19,26))
config["ADE12_WALLABY_A"]        = AntennaConfig("ADE12_WALLABY_A",        ( 1, 4, 5, 6, 7,11,13,14,15,19,21,25))
config["ADE12_WALLABY_B"]        = AntennaConfig("ADE12_WALLABY_B",        ( 1, 2, 6, 9,12,15,16,18,23,27,28,29))
config["ADE12_WALLABY_C"]        = AntennaConfig("ADE12_WALLABY_C",        ( 2, 3, 4, 6, 7,12,15,18,19,22,23,25))
#
config["ADE6"]                   = AntennaConfig("ADE6",                   ( 2, 4, 5,14,10,12))
config["ADE12"]                  = AntennaConfig("ADE12",                  ( 2, 4, 5,14,10,12,24,27,30,13,16,28))
config["ADE18"]                  = AntennaConfig("ADE18",                  ( 2, 4, 5,14,10,12,24,27,30,13,16,28,31,33,35,19,23,26))
