...
if __name__ == '__main__':
    ...
    spatHistPlot(fS,fR,xS,yS, axisrange, minRelVal=0., scaleByRel=True, absoluteSizes=True, removeZeros=True, name='F', unit='\mu Jy', locationCode=233, plotTitle='Flux difference')
