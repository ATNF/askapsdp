...
namespace askap
{
  ...
  namespace evaluation
  {
	...
	float flux(){return itsDudFlux;};
	void setFlux(float f){itsDudFlux=f;};
      private:
	...
	int itsNpixObj;
	/// @brief The integrated or peak flux of the object (whichever is not needed -- this value is not printed)
	float  itsDudFlux;
      };
