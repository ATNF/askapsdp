...
class RMSynthesisTest : public CppUnit::TestFixture {
    ...
    public:
        ...
        void testParsets()
        {
            ...
            CPPUNIT_ASSERT_EQUAL(numPhiChan, rmsynthU.numPhiChan());
            CPPUNIT_ASSERT_DOUBLES_EQUAL(deltaPhi, rmsynthU.deltaPhi(), 1.e-5);
        ...
        void testWeights()
        {
            ...
            CPPUNIT_ASSERT_DOUBLES_EQUAL(fdfnoise, rmsynthU.fdf_noise(), 1.e-5);
        ...
        void testRMsynth()
        {
            ...
            CPPUNIT_ASSERT_DOUBLES_EQUAL(RM, phi_rmsynth(locMax), 1.e-5);
        }
        ...
        void testRMSF()
        {
            ...
            CPPUNIT_ASSERT_DOUBLES_EQUAL(0., phi_rmsynth_rmsf(locMax), 1.e-5);
        ...
        void testRMSFwidth()
        {
            ...
            // REQUIRE COMPLIANCE WITHIN 10%, WHICH WORKS FOR
            // 1150-1450MHz CASE
            ...
            ASKAPLOG_DEBUG_STR(logger, "lamsq-max = " << lamsq[0] <<
                               ", lamsq-min = " << lamsq[nchan - 1]);
            ASKAPLOG_DEBUG_STR(logger, "Expect RMSF width for uniform weighting to be " <<
                               expectedRMSFwidth <<
                               " and got " << rmsynthU.rmsf_width());
            // testing for compliance within 10%
            CPPUNIT_ASSERT(fabs(rmsynthU.rmsf_width() - expectedRMSFwidth) /
                           expectedRMSFwidth < 0.1);
        }
