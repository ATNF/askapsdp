             ...
             size_t spatSize, size_t specSize)
{
    ...
    Vector<Float>::iterator iterBase(base.begin());
    Vector<Float>::iterator iterMedian(medians.begin());
    Vector<Float>::iterator iterMadfm(madfm.begin());
    Vector<Float>::iterator iterSnr(snr.begin());
    Vector<Float>::iterator iterMean(mean.begin());
    Vector<Float>::iterator iterStddev(stddev.begin());
    int i = 0, pos = 0;
...
//             -0.000660667, 0.000178434, 0.00411235, 0.00283374, -9.37844e-05};
        ...
        findSNR(input, snrAll, medAll, madfmAll, diffAll, inputAll,
                shape, box, 0, false, spatsize, specsize);
