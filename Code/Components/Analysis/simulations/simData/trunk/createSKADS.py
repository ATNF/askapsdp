...
if __name__ == '__main__':
    ...
    catalogueFilenameOrig = "data/SKADS_S3SEX_10sqdeg_1uJy_orig.dat"  # This is the name of the file that has data from the database, with positions centred on (0,0)
    catalogueFilename = "data/SKADS_S3SEX_10sqdeg_1uJy.dat"           # This is the name of the file createFITS will create with corrected positions
