    ...
    namespace analysisutilities {
        ...
        class ContinuumSUMSS : public Continuum {
            public:
                ...
                ContinuumSUMSS(float alpha, float beta, float nuZero) {defineSource(alpha, beta, nuZero);};
                /// @brief Define parameters directly
                ContinuumSUMSS(float alpha, float beta, float nuZero, float fluxZero) {defineSource(alpha, beta, nuZero); setFluxZero(fluxZero);};
                /// @brief Destructor
