...
#ifndef ASKAP_ACCESSORS_VOTABLE_VOTABLEGROUP_H
#define ASKAP_ACCESSORS_VOTABLE_VOTABLEGROUP_H
    ...
    namespace accessors {
        ...
        class VOTableGroup {
            public:
                ...
                static VOTableGroup fromXmlElement(const xercesc::DOMElement& e);
