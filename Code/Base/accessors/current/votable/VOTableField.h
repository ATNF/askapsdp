...
#ifndef ASKAP_ACCESSORS_VOTABLE_VOTABLEFIELD_H
#define ASKAP_ACCESSORS_VOTABLE_VOTABLEFIELD_H
    ...
    namespace accessors {
        ...
        class VOTableField {
            public:
                ...
                static VOTableField fromXmlElement(const xercesc::DOMElement& e);
